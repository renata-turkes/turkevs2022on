...
# test_indices = np.random.choice(np.arange(N_regular, N_regular + N_random), size = test_size, replace = False)
...
plt.savefig(PATH_RESULTS + "computation_times_regular_random", bbox_inches = "tight")
plt.show()
...
plt.savefig(PATH_RESULTS + "memory_regular_random", bbox_inches = "tight")
plt.show()
...
with open(PATH_RESULTS + "acc_ph_regular_random.pkl", "wb") as f:
    pickle.dump(acc_ph, f) 
with open(PATH_RESULTS + "acc_ml_regular_random.pkl", "wb") as f:
    pickle.dump(acc_ml, f)
with open(PATH_RESULTS + "acc_nn_shallow_regular_random.pkl", "wb") as f:
    pickle.dump(acc_nn_shallow, f) 
with open(PATH_RESULTS + "acc_nn_deep_regular_random.pkl", "wb") as f:
    pickle.dump(acc_nn_deep, f) 
with open(PATH_RESULTS + "acc_point_net_regular_random.pkl", "wb") as f:
...
plt.savefig(PATH_RESULTS + "accs_regular_random", bbox_inches = "tight")



# Confusion matrices.
print("\n\nPlotting confusion matrices...")
model.plot_confusion_matrix(data_ph_test, labels_test, None, model_trained_ph, output_path = PATH_RESULTS + "confusion_matrix_ph_regular_random")
model.plot_confusion_matrix(data_dis_mat_flat_test, labels_test, None, model_trained_ml, output_path = PATH_RESULTS + "confusion_matrix_ml_regular_random")
model.plot_confusion_matrix(data_dis_mat_flat_test, labels_test, None, model_trained_nn_shallow, output_path = PATH_RESULTS + "confusion_matrix_nn_shallow_regular_random")
model.plot_confusion_matrix(data_dis_mat_flat_test, labels_test, None, model_trained_nn_deep, output_path = PATH_RESULTS + "confusion_matrix_nn_deep_regular_random")
model.plot_confusion_matrix(data_pc_3d_test, labels_test, None, model_trained_point_net, output_path = PATH_RESULTS + "confusion_matrix_point_net_regular_random")
...
model.visualize_incorrect_predictions(data_pc_test, data_ph_test, labels_test, None, model_trained_ph, output_path = PATH_RESULTS + "wrong_predictions_ph_regular_random")
model.visualize_incorrect_predictions(data_pc_test, data_dis_mat_flat_test, labels_test, None, model_trained_ml, output_path = PATH_RESULTS + "wrong_predictions_ml_regular_random")
model.visualize_incorrect_predictions(data_pc_test, data_dis_mat_flat_test, labels_test, None, model_trained_nn_shallow, output_path = PATH_RESULTS + "wrong_predictions_nn_shallow_regular_random")
model.visualize_incorrect_predictions(data_pc_test, data_dis_mat_flat_test, labels_test, None, model_trained_nn_deep, output_path = PATH_RESULTS + "wrong_predictions_nn_deep_regular_random")
model.visualize_incorrect_predictions(data_pc_test, data_pc_3d_test, labels_test, None, model_trained_point_net, output_path = PATH_RESULTS + "wrong_predictions_point_net_regular_random")